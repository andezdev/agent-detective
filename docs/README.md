...
- **Operator hubs (start here):** [get started](operator/get-started.md) · [configuration hub](config/configuration-hub.md) · [installation](operator/installation.mdx) · [golden path](operator/golden-path.md) · [threat model](operator/threat-model.md) · [upgrading](operator/upgrading.md)
