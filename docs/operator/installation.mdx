...
**Typical reading order:** [get started](get-started.md) → [CLI reference](cli.md) → this page → [golden path](golden-path.md) → [configuration hub](../config/configuration-hub.md).
...
<Tabs syncKey="deploy">
  <TabItem label="npm CLI" icon="seti:npm">
    ...
    **What you need:** Node.js 24+, git, and the configured agent on `PATH`.
    ...
    Use `npx agent-detective` instead of a global install if you prefer. Commands: [CLI reference](cli.md). Production: [deployment.md](deployment.md).
  </TabItem>
...
- **Configuration:** JSON under `config/` ([configuration.md](../config/configuration.md)); scaffold with **`agent-detective init`** (copies `default.json` from the package). From source: copy `config/local.example.json` → `config/local.json`.
...
<CardGrid>
  ...
  <LinkCard title="CLI reference" href="/docs/operator/cli/" description="init, doctor, smoke, validate-config." />
  <LinkCard title="Golden path" href="/docs/operator/golden-path/" description="Local smoke, then first real Jira webhook." />
  <LinkCard title="Deployment" href="/docs/operator/deployment/" description="systemd, nginx, health checks." />
  <LinkCard title="Configuration" href="/docs/config/configuration/" description="Config files, env whitelist, plugin options." />
  <LinkCard title="Upgrading" href="/docs/operator/upgrading/" description="Releases and npm upgrade." />
  <LinkCard title="Jira E2E (deep dive)" href="/docs/e2e/jira-manual-e2e/" description="Tunnel, webhooks, troubleshooting." />
  <LinkCard title="Development" href="/docs/development/development/" description="Monorepo contributors." />
</CardGrid>
