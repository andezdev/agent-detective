...
- **Root** is the main app; **`packages/*`** are workspace packages. Declared in [`pnpm-workspace.yaml`](https://github.com/andezdev/agent-detective/blob/main/pnpm-workspace.yaml).
